  ...
  return (
    <div className="max-w-md mx-auto px-4 py-16">
      <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm">
        <h1 className="font-heading font-bold text-3xl text-center mb-2">Create Account</h1>
        <p className="text-center text-gray-500 text-sm mb-8">Join Dr Trend today</p>
