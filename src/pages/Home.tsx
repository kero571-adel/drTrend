    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl">
          <span className="inline-block text-primary font-semibold text-xs md:text-sm tracking-[0.3em] uppercase mb-4">
          ...
          <p className="mt-6 text-white/90 text-base md:text-lg max-w-2xl mx-auto">
            Designed for doctors, nurses, and healthcare heroes.
          </p>
          <a
            href="/shop"
          ...
          <div className="flex items-end justify-between mb-10">
            <div>
              ...
              <p className="text-gray-500 mt-2 text-sm md:text-base">
                Loved by healthcare professionals across Egypt.
              </p>
            </div>
            <a
              href="/shop"
              className="hidden sm:inline-flex items-center px-5 py-2 border border-gray-300 text-gray-700 text-sm font-medium rounded-full hover:border-primary hover:text-primary transition-colors"
            >
              Shop All
            </a>
          </div>
...
function Feature({
  ...
  return (
    ...
    >
      ...
      <h3 className="font-heading font-bold text-lg md:text-xl mb-2">{title}</h3>
