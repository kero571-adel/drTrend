  ...
  return (
    <div className="group flex flex-col">
      ...
      <div className="flex-1">
        ...
        <p className="text-primary font-semibold text-sm mt-1">{formatEGP(product.price)}</p>
        <button
          onClick={onAddToCart}
          className="mt-3 w-full bg-gray-900 hover:bg-black text-white text-xs font-semibold py-2.5 rounded-md transition-colors"
        >
          Add to Cart
        </button>
      </div>
